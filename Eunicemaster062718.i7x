...
Section 2 - Taking and Eating Everywhere

Instead of taking some scenery: say "Sometimes you can't take it with you. This is one of those times." 

A food is a kind of thing that is edible. Food has some text called nourishment. The nourishment of food is usually "Tolerable. You chew and swallow it, but don't notice much improvement."

After eating something:
	if the noun provides the property nourishment, say "[the nourishment of the noun][paragraph break]";
	otherwise say "It's [noun]-flavored." 
	[PLACEHOLDER HERE FOR EATING IN THE TROLL HOUSE
	ALSO: MAYBE FOR FUN THE TROLL LIKES TO EAT THE IRIDESCENT FLY TOO]
...
The description of the Front Yard is "You are standing in a yard just south of an old, wooden house. At one time it was a dearly loved home, a place of comfort and laughter. Now it stands silent, with its windows boarded up. Around you [if player has the flute]the garden is beginning to return to life. The rose bush has tiny pink buds, preparing to become flowers soon. [otherwise]is a neglected field that was once a beautiful garden. [line break]There is more trash here than anything else. It could use some care and tending."
...
Gap in the wood has the description "The dark forest is a solid wall. Yet, as you look you can see a break in the trees where a path into the woods leads west.".
...
Meadowland has the description "The plain field has turned into a meadow, though you are not exactly sure what changed. The wind blows gently. This would be a sweet place to sit for an afternoon in a hammock and listen to the birds sing, except that there is no hammock and no birds singing."
...
Instead of asking an awake toad about the subject Eunice:
	say "'Can you tell me more about this place?' you press. [paragraph break]'The iridescent flies are quite good' is the Toad's only reply."
...
The solitary tree is above the Grassland and below the Tree Crown. There is a yellow apple in the Tree Crown. The yellow apple is food. The description of the apple is "It is a small yellow apple. As you look closer, you notice shades of reds and browns and greens on the skin in a collection of all the colors of fall. Your mouth begins to water.".

The nourishment of the apple is "very nourishing!".
...
Prairie has the description "You are walking through a wild prairie land with thick grasses that reach up to your knees at times. Every so often you hear the sudden rustling behind you or to the side indicates the presense of some small animal foraging.".
